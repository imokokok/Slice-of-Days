...
Street locations are spaced 1600 units apart. The camera follows walking continuously; neighboring illustrations overlap with a 160-unit feathered edge, without black fades or page jumps. Player and NPC height follows the illustrated scale: 240 units in street views, 320 in interior close-ups, and 330 on the lookout terrace. Feet remain grounded, including sitting; interaction hints sit above the enlarged silhouettes. Version-4 street save positions are scaled to the new width while keeping their location. New games still start on the left.
