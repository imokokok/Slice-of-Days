...
Each street location is a full 1600-by-900 stage. Walking across a boundary reveals the next plate with a brief fade, avoiding visible collage seams between independently composed illustrations. Version-4 street save positions are scaled to the new width while keeping their location. New games still start on the left.
