...
- A/D 或左右键行走，Shift 快走；走近人物按 W 交谈，走近门、路口和物件按 E 互动。其他功能都有独立快捷键。
...
- NPC 对话始终保留场景。Space 继续（Enter 仍可兼容），直接点击完整回应句子或用方向键与 Enter 选择，T 切换逐字显示，Esc 自然告别；不再使用 1/2/3/4 话题菜单。
