...
const WritingPen=preload("res://extensions/collage_letter/scripts/writing_pen.gd")
var g
var shelf: Control
var kit: Control
var drag_id: int=-1
...
func finish_book_turn(old_leaf: ImageTexture, direction: int) -> void:
	...
	var leaf=preload("res://extensions/collage_letter/scripts/book_turn.gd").new();leaf.name="TurningLeaf";leaf.leaf=old_leaf;leaf.direction=direction;leaf.position=Vector2(25,12);leaf.size=Vector2(317,598)
