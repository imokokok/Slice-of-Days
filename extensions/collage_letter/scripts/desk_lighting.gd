...
func _ready() -> void:
	...
	shade=ShaderMaterial.new();shade.shader=preload("res://extensions/collage_letter/assets/shaders/desk_daylight.gdshader");panel.material=shade;add_child(panel)
	refresh(0)
