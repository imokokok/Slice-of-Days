...
func draw() -> void:
	...
	var hint_skin:=preload("res://extensions/collage_letter/scripts/journal_style.gd").rounded(Color("efe3c8"),7)
...
func draw_mailbox() -> void:
	...
	g.draw_style_box(preload("res://extensions/collage_letter/scripts/journal_style.gd").rounded(Color("456466"),12),Rect2(915,376,335,310))
