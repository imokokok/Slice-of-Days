...
func feedback(found: bool) -> void:
 var path := "res://extensions/observatory/assets/audio/constellation_found.ogg" if found else "res://extensions/observatory/assets/audio/telescope_click.ogg"
 if not ResourceLoader.exists(path): path = "res://extensions/observatory/assets/audio/chime_placeholder.wav"
 if ResourceLoader.exists(path):
