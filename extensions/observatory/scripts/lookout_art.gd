...
const PLATFORM = preload("res://extensions/observatory/assets/background/lookout_platform_supplied.jpg")
const SCREEN = preload("res://extensions/observatory/assets/background/lookout_screen_supplied.jpg")
const Paper = preload("res://extensions/observatory/scripts/authored_jpeg.gd")
