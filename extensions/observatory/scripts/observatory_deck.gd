...
const Art = preload("res://extensions/observatory/scripts/lookout_art.gd")
const COAST = preload("res://extensions/observatory/assets/background/lookout_coast_night.png")
