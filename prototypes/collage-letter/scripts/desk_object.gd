...
func _draw() -> void:
	...
	match kind:
		...
		"bottle_full","bottle_empty":
			...
			if kind=="bottle_full":
				draw_style_box(preload("res://scripts/journal_style.gd").rounded(Color("e8dbbd"),5),Rect2(-9,55,18,76));draw_line(Vector2(3,60),Vector2(3,123),Color("b8a484"),1,true)
			...
			draw_style_box(preload("res://scripts/journal_style.gd").rounded(Color("b18b5f"),3),Rect2(-14,8,28,20))
		...
		"typewriter":
			preload("res://scripts/typewriter_art.gd").paint(self,Rect2(lift,Vector2(w,h-12)))
...
func draw_folio(w: float,h: float) -> void:
	...
	var skin:=preload("res://scripts/journal_style.gd").rounded(Color("809383"),8)
	...
	draw_style_box(preload("res://scripts/journal_style.gd").rounded(Color("809383"),7),Rect2(0,0,361,510))
...
func draw_stationery_box(rect:Rect2,opened:bool) -> void:
	preload("res://scripts/stationery_box.gd").paint(self,rect,opened)
