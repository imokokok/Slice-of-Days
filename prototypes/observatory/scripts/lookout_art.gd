...
const PLATFORM = preload("res://assets/background/lookout_platform_supplied.jpg")
const SCREEN = preload("res://assets/background/lookout_screen_supplied.jpg")
const Paper = preload("res://scripts/authored_jpeg.gd")
