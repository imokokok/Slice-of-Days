...
try {
    ...
    $sharedFiles = @('README.md', 'project.godot', 'scripts/ui/town_day.gd', 'scripts/ui/interactive_space.gd', 'scripts/core/scene_router.gd', 'scripts/residency/recorder_lite.gd', 'scripts/residency/paper_overlay.gd', 'scripts/ui/components/live_sound_window.gd', 'scripts/ui/components/media_browser.gd', 'export_presets.cfg', 'THIRD_PARTY_LICENSES.md', 'scripts/core/character_system.gd', 'scripts/core/save_manager.gd', 'scripts/core/ui_state_system.gd', 'scripts/residency/gameplay_shell.gd', 'scripts/ui/extension_host.gd', 'scripts/ui/native_module_game.gd', 'scripts/ui/components/cooking_board.gd', 'extensions/collage_letter/scripts/audio_manager.gd', 'extensions/observatory/scripts/audio_manager.gd', 'extensions/myriorama_tarot/scripts/sound.gd', 'tests/integration/test_global_recording.gd', 'tests/integration/test_five_day_flow.gd', 'tests/integration/test_recorder_movement.gd', 'tests/integration/test_recording_retry.gd', 'tests/integration/test_ui_reference_review.gd')
